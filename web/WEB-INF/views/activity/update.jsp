                    ...
                    <form  id= "saveForm" method="post" class="layui-form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="title" id="title" value="${Activity.title}" lay-verify="required" lay-verType="tips" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">开始时间</label>
                            <div class="layui-input-inline">
                                <input type="text" name="start_time" id="start_time" value="${Activity.start_time}" lay-verify="required" lay-verType="tips" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="end_time" id="end_time" value="${Activity.end_time}" lay-verify="required" lay-verType="tips" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="number" name="total" id="total" value="${Activity.total}" lay-verify="required" lay-verType="tips" class="layui-input">
                            </div>
                        </div>
                            ...
                            <div class="layui-input-inline">
                                <select name="cname" id="cname" >
                                    <c:forEach items="${categoryList}" var="data"  >
                                        <option value="${data.cname}" <c:if test="${Activity.cname == data.cname }">selected </c:if>>${data.cname}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <textarea  name="note" id="note" class="layui-textarea">${Activity.note}</textarea>
                            </div>
                        </div>

                        <input type="hidden" name="img" class="img" value="${Activity.img}">
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <script id="container" name="detail" type="text/plain">${Activity.detail}</script>
                            </div>
                        </div>
                        <br>
                        <div class="layui-form-item">
