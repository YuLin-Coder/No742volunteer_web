        ...
        <div class="layui-col-md8 content detail">
            <div class="fly-panel detail-box">
                ...
                <div class="fly-detail-info">
                    ...
                    <span class="layui-badge layui-bg-green fly-detail-column">${activity.cname}</span>
                </div>
                <div class="detail-about">
                    <a class="fly-avatar">
                        <img src="/images/${activity.img}" alt="贤心">
                    </a>
                    <div class="fly-detail-user">
                        <span>发布日期：${activity.fbrq}</span>
                    </div>
                    <div class="detail-hits" id="LAY_jieAdmin" data-id="123">
                        <span style="padding-right: 10px; color: #FF7200">报名日期：${activity.start_time}——${activity.end_time}</span>
                        <span class="layui-btn layui-btn-xs layui-btn-normal jie-admin" type="edit">
                            总人数：${activity.total}</span>
                        <span class="layui-btn layui-btn-xs jie-admin" type="edit">
                            已报名人数：${activity.yzmcount}</span>
                    </div>
                </div>
                <div class="detail-body photos">
                    ...
                    封面<hr>
                    <p>
                        <img src="/images/${activity.img}" alt="Fly社区">
                    </p>
                    内容<hr>
                    <p>
                        ${activity.detail}
